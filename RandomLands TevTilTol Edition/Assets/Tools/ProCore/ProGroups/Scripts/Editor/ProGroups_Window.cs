...
#region Class Variables
		...
		private Group expandedGroup = null;
		...
		void OnGUI()
		{
			...
			if(groupContainer.sceneGroups != null)
			{
				...
				for(int i = 0; i < groupContainer.sceneGroups.Length; i++)
				{
					...
					Rect rowRect = new Rect(r.x, r.y + r.height + 2, Screen.width-4, 20);
					...
					if( group == expandedGroup && group.objects.Length > 0 )
					{
